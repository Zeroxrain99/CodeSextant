...
TOOLS: tuple[Tool, ...] = (
    Tool(
        ...
        description=(
            ...
            "files that name it as leads and says why it stopped short. Below those, "
            "marked '?', the files that import this module - the weakest of the three "
            "claims and the only one that says anything about a symbol you have not "
            "written yet.\n"
